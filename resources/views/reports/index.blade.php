                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                        <div class="md:col-span-5">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="search" name="search" value="{{ request('search') }}" placeholder="ID Tiket atau Judul..."
            ...
            <div class="space-y-4">
                            ...
                            <div class="flex items-start justify-between mb-4">
                                <div class="flex-1">
                                    <div class="flex items-center space-x-3 mb-2">
                                        ...
                                        <span class="px-3 py-1 {{ $badgeColor }} text-xs font-semibold rounded-full uppercase">
                                            {{ $statusLabel }}
                                        </span>
                                    </div>
                ...
                @empty
                    <div class="bg-white rounded-lg shadow-sm p-8 text-center">
                        ...
                        <a href="{{ route('reports.create') }}" class="inline-flex items-center px-4 py-2 bg-yellow-500 hover:bg-yellow-600 text-blue-900 font-semibold rounded-lg transition">
